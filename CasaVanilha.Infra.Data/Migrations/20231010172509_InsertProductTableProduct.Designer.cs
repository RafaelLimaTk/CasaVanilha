...
namespace CasaVanilha.Infra.Data.Migrations
{
    ...
    [Migration("20231010172509_InsertProductTableProduct")]
    partial class InsertProductTableProduct
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CasaVanilha.Domain.Entities.Sale", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CasaVanilha.Domain.Entities.OrderItem", b =>
                {
                    b.HasOne("CasaVanilha.Domain.Entities.Order", null)
                        .WithMany("OrderItems")
                        .HasForeignKey("Id")
                        .IsRequired();
